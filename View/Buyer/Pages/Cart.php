...
$buyerController->checkBuyerSession();

$productId = (int)($_GET['product_id'] ?? $_POST['product_id'] ?? 0);
$product = $buyerController->getProduct($productId);

$message = '';
$messageClass = '';

if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['checkout'])) {
    $response = $buyerController->placeOrder();
    $message = $response['message'];
    $messageClass = $response['success'] ? 'success-message' : 'error-message';
}
...
<section class="buyer-cart-page">
            ...
            <div class="buyer-cart-layout">
                ...
                <div class="selected-product-area">
                    ...
                    <div class="selected-product-info">
                        ...
                        <p class="small-label">SELECTED PRODUCT</p>
                ...
                <div class="checkout-side">
                    ...
                    <div class="checkout-box order-summary-box">
                        ...
                        <div class="summary-row">
                            <p>Product Price</p>
                            <p><?= htmlspecialchars($product['price']) ?> TK</p>
                        </div>
                        ...
                        <div class="summary-row total-row">
                            ...
                            <p>
                                <?= number_format(
                                    ((float)$product['price'] * $quantity) + 100,
                                    2
                                ) ?> TK
                            </p>
                        </div>
    ...
    <?php else: ?>
        ...
        <div class="no-product-box">
            ...
            <a href="../../Common/Pages/shop.php">Go To Shop</a>
        </div>
